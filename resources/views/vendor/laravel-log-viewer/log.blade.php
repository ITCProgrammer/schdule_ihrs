...
<head>
  ...
  <title>IHRS Log Viewer</title>
  <!-- Icon app -->
  <link rel="icon" type="image/png" href="{{ asset('ITTI_Logo.ico') }}" />
  <link rel="stylesheet"
...
<div class="container-fluid">
  <div class="row">
    <div class="col sidebar mb-3">
      <h1><i class="fa fa-calendar" aria-hidden="true"></i> IHRS Log Viewer</h1>
      <p class="text-muted"><i>by DIT ITTI</i></p>
